...
\begin{figure}[t]
	\centering
           \includegraphics[width=0.45\textwidth]{./figures/PMTmount2.jpg} 
...
\begin{figure}[t]
\centering	
%\includegraphics[width=0.45\textwidth]{./figures/mountedpmtlabeled.jpg}
%\includegraphics[width=0.45\textwidth]{./figures/PMTunit2.pdf}
...
\begin{figure}[h]
\centering 
%\includegraphics[width=0.7\textwidth]{./figures/splitter.png}
\includegraphics[width=0.7\textwidth]{./figures/splitter_modified.png}
